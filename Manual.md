...
subsampling method for poisson regression (uniform distribution)
================

# 1. Overview

-   The project ***“Uniform_Distribution”*** or
    ***“RS_OS_MROS_PR_TwoVar_Uniform”*** is developed for the purpose of
...
-   Based on the real model of the poisson regression data we have four
    ...
    by using ***Checking_SP_Model_1\_Uniform_Special.R***.
...
1.  *θ* = \[1.0,0.3,0.3\] generates data for Model 1 of
    *x*<sub>1</sub>, *x*<sub>2</sub>.
2.  *θ* = \[1.0,0.7,−0.5,0.4\] generates data for Model 2 of
    *x*<sub>1</sub>, *x*<sub>2</sub>, *x*<sub>1</sub><sup>2</sup>.
3.  *θ* = \[1.0,−0.4,0.5,0.3\] generates data for Model 3 of
    *x*<sub>1</sub>, *x*<sub>2</sub>, *x*<sub>2</sub><sup>2</sup>.
4.  *θ* = \[1.0,0.5,0.5,−0.3,0.5\] generates data for Model 4 of
    *x*<sub>1</sub>, *x*<sub>2</sub>, *x*<sub>1</sub><sup>2</sup>, *x*<sub>2</sub><sup>2</sup>.

-   For each model structure covariate data was generated only through a
...
-   Use **Articles.Rmd** to generate plots relevant to the paper as pdf
    files **SMSE_MI_PR_TV_Uni_mMSE.pdf** and
    **SMSE_MI_PR_TV_Uni_mVc.pdf**.
