...
```{r Load Data}
Path<-here("Identical_r0","Outputs","Classical",params$Model_Path,"OSMAC","Real_Model/")
...
Path<-here("Identical_r0","Outputs","Classical",params$Model_Path,"OSMAC","Assumed_Model/")
# Assumed Model 1
...
Path<-here("Identical_r0","Outputs","Classical",params$Model_Path,"OSMAC","ModelFree/")
load(here(Path,"OSMAC_output.RData"))
...
anim_save(filename="para_1.gif",animation = para_1,
          path=here("Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots"))

include_graphics2(here("Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","para_1.gif"))
```
...
include_graphics2(here("Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","Bias_1.gif"))
```
...
include_graphics2(here("Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","U_1.gif"))
...
include_graphics2(here("Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","U_2.gif"))
```
...
save(All_MSE,All_EMSE,All_Bias,All_VAR,All_Info,Accuracy_Data,
     file = here("Identical_r0","Summary","Classical",params$Model_Path,"Data","Efficiency",
