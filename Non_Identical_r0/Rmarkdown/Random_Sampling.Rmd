...
```{r Load Data RM}
Path<-here("Non_Identical_r0","Outputs",params$Model_Path,"Random_Sampling","Real_Model/")
...
```{r Load Data AM 1}
Path<-here("Non_Identical_r0","Outputs",params$Model_Path,"Random_Sampling","Assumed_Model_1/")
load(here(Path,"Random_Sample_output.RData"))
...
```{r Load Data AM 2}
Path<-here("Non_Identical_r0","Outputs",params$Model_Path,"Random_Sampling","Assumed_Model_2/")
load(here(Path,"Random_Sample_output.RData"))
...
```{r Load Data AM 3}
Path<-here("Non_Identical_r0","Outputs",params$Model_Path,"Random_Sampling","Assumed_Model_3/")
load(here(Path,"Random_Sample_output.RData"))
...
anim_save(filename="para_1.gif",animation = para_1,
          path=here("Non_Identical_r0","htmloutputs",params$Model_Path,"Random_Sampling","Plots"))

include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"Random_Sampling","Plots","para_1.gif"))
```
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"Random_Sampling","Plots","Bias_1.gif"))
```
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"Random_Sampling","Plots","U_1.gif"))
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"Random_Sampling","Plots","U_2.gif"))
```
