...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","r1_para_1.gif"))
```
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","r1_Bias_1.gif"))
```
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","r1_U_1.gif"))
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","r1_U_2.gif"))
```
