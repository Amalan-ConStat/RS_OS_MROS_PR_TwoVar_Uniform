...
```{r Load Data}
Path<-here("Non_Identical_r0","Outputs","Classical",params$Model_Path,"OSMAC","Real_Model/")
...
Path<-here("Non_Identical_r0","Outputs","Classical",params$Model_Path,"OSMAC","Assumed_Model_1/")
load(here(Path,"OSMAC_output.RData"))
...
Path<-here("Non_Identical_r0","Outputs","Classical",params$Model_Path,"OSMAC","Assumed_Model_2/")
load(here(Path,"OSMAC_output.RData"))
...
Path<-here("Non_Identical_r0","Outputs","Classical",params$Model_Path,"OSMAC","Assumed_Model_3/")
load(here(Path,"OSMAC_output.RData"))
...
anim_save(filename="para_1.gif",animation = para_1,
          path=here("Non_Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots"))

include_graphics2(here("Non_Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","para_1.gif"))
```
...
include_graphics2(here("Non_Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","Bias_1.gif"))
```
...
include_graphics2(here("Non_Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","U_1.gif"))
...
include_graphics2(here("Non_Identical_r0","htmloutputs","Classical",params$Model_Path,"OSMAC","Plots","U_2.gif"))
```
